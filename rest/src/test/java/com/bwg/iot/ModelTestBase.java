...
public class ModelTestBase {
    ...
    protected List<Material> setupTestMaterials(Oem oem1, Oem oem2){
        ...
        Material material6 = createMaterial(Component.ComponentType.CONTROLLER.name(), CONTROLLER1_BRAND_NAME, CONTROLLER1_DESCRIPTION, CONTROLLER1_SKU, null, THREE_YEAR_WARRANTY_DAYS, justOne);
        Material material7 = createMaterial(Component.ComponentType.CONTROLLER.name(), CONTROLLER2_BRAND_NAME, CONTROLLER2_DESCRIPTION, CONTROLLER2_SKU, null, THREE_YEAR_WARRANTY_DAYS, justTwo);
        Material material8 = createMaterial(Component.ComponentType.CONTROLLER.name(), CONTROLLER3_BRAND_NAME, CONTROLLER3_DESCRIPTION, CONTROLLER3_SKU, null, THREE_YEAR_WARRANTY_DAYS, justTwo);
        Material material9 = createMaterial(Component.ComponentType.CONTROLLER.name(), CONTROLLER4_BRAND_NAME, CONTROLLER4_DESCRIPTION, CONTROLLER4_SKU, null, THREE_YEAR_WARRANTY_DAYS, justTwo);
    ...
    protected List<Material> setupSeveralTestMaterials(Oem oem1, Oem oem2){
        ...
        materialList.add(createMaterial(Component.ComponentType.CONTROLLER.name(), CONTROLLER1_BRAND_NAME, CONTROLLER1_DESCRIPTION, CONTROLLER1_SKU, null, THREE_YEAR_WARRANTY_DAYS, justOne));
        materialList.add(createMaterial(Component.ComponentType.CONTROLLER.name(), CONTROLLER2_BRAND_NAME, CONTROLLER2_DESCRIPTION, CONTROLLER2_SKU, null, THREE_YEAR_WARRANTY_DAYS, justTwo));
        materialList.add(createMaterial(Component.ComponentType.CONTROLLER.name(), CONTROLLER3_BRAND_NAME, CONTROLLER3_DESCRIPTION, CONTROLLER3_SKU, null, THREE_YEAR_WARRANTY_DAYS, justTwo));
        materialList.add(createMaterial(Component.ComponentType.CONTROLLER.name(), CONTROLLER4_BRAND_NAME, CONTROLLER4_DESCRIPTION, CONTROLLER4_SKU, null, THREE_YEAR_WARRANTY_DAYS, justTwo));
        materialList.add(createMaterial(Component.ComponentType.CONTROLLER.name(), "Jacuzzi® 1000™ Control System", "BOARD JACWHL J1000 CE MIL COM", "25119", null, THREE_YEAR_WARRANTY_DAYS, bothOems));

        materialList.add(createMaterial(Component.ComponentType.GATEWAY.name(), "Triton Gateway: Beta 01", "rPi , Agent 1.0.0", "17092-83280-1a", null, THREE_YEAR_WARRANTY_DAYS, bothOems));
        materialList.add(createMaterial(Component.ComponentType.GATEWAY.name(), "Triton Gateway: Beta 03", "ts7970 , Agent 1.0.0", "17092-83280-1b", null, THREE_YEAR_WARRANTY_DAYS, bothOems));
        ...
        materialList.add(createMaterial(Component.ComponentType.MOTE.name(), "Triton Current Mote: Beta 02", "tbd", "1-000020-1", null, THREE_YEAR_WARRANTY_DAYS, justOne));
        materialList.add(createMaterial(Component.ComponentType.MOTE.name(), "Triton Current Mote: Beta 01", "acme inc.", "88-441a4", null, THREE_YEAR_WARRANTY_DAYS, justOne));

        materialList.add(createMaterial(Component.ComponentType.LIGHT.name(), "Standard White Light", "150W, 110V White", "1435661-01", null, THREE_YEAR_WARRANTY_DAYS, bothOems));
        materialList.add(createMaterial(Component.ComponentType.LIGHT.name(), "Standard Red Light", "150W, 110V Red", "1435661-01", null, THREE_YEAR_WARRANTY_DAYS, bothOems));
        materialList.add(createMaterial(Component.ComponentType.LIGHT.name(), "Standard Blue Light", "150W, 110V Blue", "214222", null, THREE_YEAR_WARRANTY_DAYS, bothOems));
        materialList.add(createMaterial(Component.ComponentType.LIGHT.name(), "Bright White Light", "250W, 110V White", "14214-01", null, THREE_YEAR_WARRANTY_DAYS, bothOems));
        materialList.add(createMaterial(Component.ComponentType.LIGHT.name(), "Disco Ball", "390W, 110V Multi-color", "213144", null, THREE_YEAR_WARRANTY_DAYS, bothOems));
        materialList.add(createMaterial(Component.ComponentType.LIGHT.name(), "MoodEFX™ LED Lights (23138)", "22 per pack", "231138", null, THREE_YEAR_WARRANTY_DAYS, bothOems));
        
        materialList.add(createMaterial(Component.ComponentType.OZONE.name(), "O3zone Cartridge", "Ozone Generator, CD Cartridge", "54451", null, THREE_YEAR_WARRANTY_DAYS, bothOems));
        materialList.add(createMaterial(Component.ComponentType.OZONE.name(), "O3zone", "UV O3 Ozone (59024)", "59024", null, THREE_YEAR_WARRANTY_DAYS, bothOems));
        materialList.add(createMaterial(Component.ComponentType.OZONE.name(), "O3zone Chip", "Ozone Adapter AMP to J&J, To J&J PSA-103-07", "21702", null, THREE_YEAR_WARRANTY_DAYS, bothOems));
        materialList.add(createMaterial(Component.ComponentType.OZONE.name(), "O3zone Chip", "Ozone Adapter AMP to J&J, To J&J SS2 PSA-103-02", "21703", null, THREE_YEAR_WARRANTY_DAYS, bothOems));
        materialList.add(createMaterial(Component.ComponentType.OZONE.name(), "O3zone Chip", "Ozone Adapter AMP to J&J, To J&J SS2 PSA-102-FM", "21704", null, THREE_YEAR_WARRANTY_DAYS, bothOems));
        materialList.add(createMaterial(Component.ComponentType.OZONE.name(), "O3zone Chip", "Ozone Adapter AMP to J&J, To J&J SS2 PSA-103-L", "21705", null, THREE_YEAR_WARRANTY_DAYS, bothOems));
        materialList.add(createMaterial(Component.ComponentType.OZONE.name(), "O3zone Chip", "Ozone Adapter AMP to J&J, To J&J SS2 PSA-103P-3", "21706", null, THREE_YEAR_WARRANTY_DAYS, bothOems));

        materialList.add(createMaterial(Component.ComponentType.FILTER.name(), "Standard Filter", "Clean Zone System", "808-qq9", null, THREE_YEAR_WARRANTY_DAYS, bothOems));
        materialList.add(createMaterial(Component.ComponentType.FILTER.name(), "Deluxe", "Clean Zone II UV System", "808-x21", null, THREE_YEAR_WARRANTY_DAYS, bothOems));

        materialList.add(createMaterial(Component.ComponentType.MICROSILK.name(), "MicroSilk® Spa 50Hz Tankless System", "50438-XX  with Overlay 13141 (Jets/Aux/MicroSilk/Light)", "58952-V", null, THREE_YEAR_WARRANTY_DAYS, bothOems));
        materialList.add(createMaterial(Component.ComponentType.MICROSILK.name(), "MicroSilk® Spa 50Hz V3 2 Tank System", "", "58953-V3", null, THREE_YEAR_WARRANTY_DAYS, bothOems));
        materialList.add(createMaterial(Component.ComponentType.MICROSILK.name(), "MicroSilk® Spa 60Hz V3 2 Tank System", "", "58962-V3", null, THREE_YEAR_WARRANTY_DAYS, bothOems));
        materialList.add(createMaterial(Component.ComponentType.MICROSILK.name(), "MicroSilk® Spa 115V V3 2 Tank System", "Panel TP800 50318-XX with Overlay 12719", "58965-V3", null, THREE_YEAR_WARRANTY_DAYS, bothOems));

        materialList.add(createMaterial(Component.ComponentType.BLOWER.name(), "spa compact quiet-flo blower", "V/Hz: 115V/60Hz Amps: 6.3m, Horsepower: 1,Cord: NEMA plug", "8141-0020", null, THREE_YEAR_WARRANTY_DAYS, bothOems));
        materialList.add(createMaterial(Component.ComponentType.BLOWER.name(), "spa compact quiet-flo blower with heater", "V/Hz: 115V/60Hz Amps: 11.9m, 600W,Cord: NEMA plug", "8141-6020", null, THREE_YEAR_WARRANTY_DAYS, bothOems));

        materialList.add(createMaterial(Component.ComponentType.MISTER.name(), "Mister 2000", "Mister KJFL33", "51151", null, THREE_YEAR_WARRANTY_DAYS, bothOems));
        materialList.add(createMaterial(Component.ComponentType.MISTER.name(), "Deluxe Mister", "Mister, 6 ", "51152", null, THREE_YEAR_WARRANTY_DAYS, bothOems));

        materialList.add(createMaterial(Component.ComponentType.AUX.name(), "BLUEWAVE™ Spa Stereo System", "Play Music from you iphone", "808-441a4", null, THREE_YEAR_WARRANTY_DAYS, justOne));
        materialList.add(createMaterial(Component.ComponentType.AUX.name(), "Bose Wireless Stereo", "SoundTouch® 10 wireless music system.", "808-441a5", null, THREE_YEAR_WARRANTY_DAYS, bothOems));
        materialList.add(createMaterial(Component.ComponentType.AUX.name(), "Umbrella Stereo", "Seranata Patio Umbrella w/ Stereo System", "808-441a6", null, THREE_YEAR_WARRANTY_DAYS, bothOems));
        materialList.add(createMaterial(Component.ComponentType.AUX.name(), "Waterfall", "Aurora Cascade Water Feature", "001820001", null, THREE_YEAR_WARRANTY_DAYS, bothOems));
        materialList.add(createMaterial(Component.ComponentType.AUX.name(), "Dynamic Jet Sequencer", "Dynamic Jet Sequencer", "22144144", null, THREE_YEAR_WARRANTY_DAYS, bothOems));

        materialList.add(createMaterial(Component.ComponentType.PANEL.name(), "ML7 Series", "PANEL JACEUR ML700 NO JETS 2 (1)", "53727", null, THREE_YEAR_WARRANTY_DAYS, justOne));
        materialList.add(createMaterial(Component.ComponentType.PANEL.name(), "ML9 Series", "PANEL JACEUR ML900 NO JETS 2 (1)", "53729", null, THREE_YEAR_WARRANTY_DAYS, justOne));


        materialList.add(createMaterial(Component.ComponentType.PANEL.name(), "ML Series, ML900", "ML900, 12 Button, 11.64 x 3.14 in", "52026", null, THREE_YEAR_WARRANTY_DAYS, justTwo));
        materialList.add(createMaterial(Component.ComponentType.PANEL.name(), "ML Series, ML700", "ML700, 8 Button, 9.82 x 3.14 in", "52622", null, THREE_YEAR_WARRANTY_DAYS, justTwo));
        materialList.add(createMaterial(Component.ComponentType.PANEL.name(), "ML Series, ML550", "ML900, 4 Button, 7.53 x 2.32", "52131", null, THREE_YEAR_WARRANTY_DAYS, justTwo));
        materialList.add(createMaterial(Component.ComponentType.PANEL.name(), "ML Series, ML260", "ML900, 12 Button, 13.22 x 4.2", "52111", null, THREE_YEAR_WARRANTY_DAYS, justTwo));
        materialList.add(createMaterial(Component.ComponentType.PANEL.name(), "TP Series, TP600", "TP600, 6 Button, 7.22 x 4.2", "59150", null, THREE_YEAR_WARRANTY_DAYS, justTwo));
        materialList.add(createMaterial(Component.ComponentType.PANEL.name(), "TP Series, TP800", "TP600, 8 Button, 7.22 x 4.2", "59180", null, THREE_YEAR_WARRANTY_DAYS, justTwo));
        materialList.add(createMaterial(Component.ComponentType.PANEL.name(), "TP Series, TP900", "TP600, 9 Button, 11.22 x 4.2", "59100", null, THREE_YEAR_WARRANTY_DAYS, justTwo));
        materialList.add(createMaterial(Component.ComponentType.PANEL.name(), "VL Series, VL701", "701, 7 Button, 10.3 x 4.6", "54652", null, THREE_YEAR_WARRANTY_DAYS, justTwo));
        materialList.add(createMaterial(Component.ComponentType.PANEL.name(), "VL Series, VL702", "702, 7 Button, 10.3 x 4.6", "54654", null, THREE_YEAR_WARRANTY_DAYS, justTwo));
        materialList.add(createMaterial(Component.ComponentType.PANEL.name(), "VL Series, VL404", "4 Button, 5.3 x 4.6", "54633", null, THREE_YEAR_WARRANTY_DAYS, justTwo));
        materialList.add(createMaterial(Component.ComponentType.PANEL.name(), "VL Series, VL404T", "4 Button, 6.3 x 4.6", "54655", null, THREE_YEAR_WARRANTY_DAYS, justTwo));

        materialList.add(createMaterial(Component.ComponentType.MISTER.name(), "Mister Mister", "2k J", "15511", null, THREE_YEAR_WARRANTY_DAYS, bothOems));
        materialList.add(createMaterial(Component.ComponentType.MISTER.name(), "Misty Fire", "2526-L", "15512", null, THREE_YEAR_WARRANTY_DAYS, justOne));
