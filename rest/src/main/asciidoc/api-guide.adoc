...
[[resource-ambientHumidityMeasurements]]

=== Get Ambient Humidity Measurements

A `GET` request to list ambient humidity measurements of selected spa.

==== Response structure

include::{snippets}/ambientHumidityMeasurements-list-example/response-fields.adoc[]

==== Example request

include::{snippets}/ambientHumidityMeasurements-list-example/curl-request.adoc[]

==== Example response

include::{snippets}/ambientHumidityMeasurements-list-example/http-response.adoc[]
...
[[resource-ambientTempMeasurementsByMote]]

=== Get Ambient Temp Measurements By Mote

A `GET` request to will list ambient temp measurements of selected spa and mote.

==== Response structure

include::{snippets}/ambientTempMeasurementsByMote-list-example/response-fields.adoc[]

==== Example request

include::{snippets}/ambientTempMeasurementsByMote-list-example/curl-request.adoc[]

==== Example response

include::{snippets}/ambientTempMeasurementsByMote-list-example/http-response.adoc[]


[[resource-ambientTempMeasurementsByMoteAndSensor]]

=== Get Ambient Temp Measurements By Mote and Sensor

A `GET` request to list all measurements of selected mote and sensor

==== Response structure

include::{snippets}/ambientTempMeasurementsByMoteAndSensor-list-example/response-fields.adoc[]

==== Example request

include::{snippets}/ambientTempMeasurementsByMoteAndSensor-list-example/curl-request.adoc[]

==== Example response

include::{snippets}/ambientTempMeasurementsByMoteAndSensor-list-example/http-response.adoc[]
