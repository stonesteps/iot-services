...
include::{snippets}/dashboard-oem-example/response-fields.adoc[]

==== Links

The links below provide access to the lists of alerts, spas, messages, and spa owners represented in the statistics.

include::{snippets}/dashboard-oem-example/links.adoc[]


==== Example request

This example requests information for all of an OEM's spas.

include::{snippets}/dashboard-oem-example/curl-request.adoc[]

==== Example response

include::{snippets}/dashboard-oem-example/http-response.adoc[]
...
[[resource-ambientHumidityMeasurementsByTypeAndSpa]]

=== Get Ambient Humidity Measurements by Spa

A `GET` request to list humidity measurements of selected spa.

==== Response structure

include::{snippets}/ambientHumidityMeasurementsByTypeAndSpa-list-example/response-fields.adoc[]

==== Example request

include::{snippets}/ambientHumidityMeasurementsByTypeAndSpa-list-example/curl-request.adoc[]

==== Example response

include::{snippets}/ambientHumidityMeasurementsByTypeAndSpa-list-example/http-response.adoc[]



[[resource-acCurrentMeasurementsByMote]]

=== Get AC Current Measurements By Mote

A `GET` request to will list ac current measurements of selected spa and mote.

==== Response structure

include::{snippets}/acCurrentMeasurementsByMote-list-example/response-fields.adoc[]

==== Example request

include::{snippets}/acCurrentMeasurementsByMote-list-example/curl-request.adoc[]

==== Example response

include::{snippets}/acCurrentMeasurementsByMote-list-example/http-response.adoc[]


[[resource-measurementsByMote]]

=== Get Measurements By Mote

A `GET` request to will list all measurements of selected spa and mote.

==== Response structure

include::{snippets}/measurementsByMote-list-example/response-fields.adoc[]

==== Example request

include::{snippets}/measurementsByMote-list-example/curl-request.adoc[]

==== Example response

include::{snippets}/measurementsByMote-list-example/http-response.adoc[]


[[resource-ambientTempMeasurementsBySensor]]

=== Get all measurements of an Ambient Temp Sensor

A `GET` request to list all measurements of selected sensor

==== Response structure

include::{snippets}/ambientTempMeasurementsBySensor-list-example/response-fields.adoc[]

==== Example request

include::{snippets}/ambientTempMeasurementsBySensor-list-example/curl-request.adoc[]

==== Example response

include::{snippets}/ambientTempMeasurementsBySensor-list-example/http-response.adoc[]
...
*/alerts/search/findByOemId?oemId*

This request will list all alerts related to spas built by a manufacturer

==== Response structure

include::{snippets}/alerts-findbyoem-example/response-fields.adoc[]

==== Example request

include::{snippets}/alerts-findbyoem-example/curl-request.adoc[]

==== Example response

include::{snippets}/alerts-findbyoem-example/http-response.adoc[]


=== List Alerts By Dealer

*/alerts/search/findByDealerId?dealerId*

This request will list all alerts related to spas built by a manufacturer

==== Response structure

include::{snippets}/alerts-findbydealer-example/response-fields.adoc[]

==== Example request

include::{snippets}/alerts-findbydealer-example/curl-request.adoc[]

==== Example response

include::{snippets}/alerts-findbydealer-example/http-response.adoc[]


=== List Alerts By Spa

*/alerts/search/findBySpaId?spaId*

This request will list all alerts related to spas built by a manufacturer

==== Response structure

include::{snippets}/alerts-findbyspa-example/response-fields.adoc[]

==== Example request

include::{snippets}/alerts-findbyspa-example/curl-request.adoc[]

==== Example response

include::{snippets}/alerts-findbyspa-example/http-response.adoc[]
...
[[resources-alert-clear]]
=== Clear an alert

A `POST` request is used to clear an alert. Sets clearedDate for alert and clearedByUserId. Updates also
alertState of spa.currentState to the highest severity of active alert (with clearedDate set to null). Updates
also alertState of respective components in spa.currentState.components.

==== Request structure

include::{snippets}/alert-clear-example/request-fields.adoc[]

==== Example request

include::{snippets}/alert-clear-example/curl-request.adoc[]

==== Example response

include::{snippets}/alert-clear-example/http-response.adoc[]
...
*/dealers/search/findByOemId?oemId*

This request will list all dealers associated with a specific spa manufacturer.


==== Response structure

include::{snippets}/dealers-findbyoem-example/response-fields.adoc[]

==== Example request

include::{snippets}/dealers-findbyoem-example/curl-request.adoc[]

==== Example response

include::{snippets}/dealers-findbyoem-example/http-response.adoc[]
...
*/user-registration/{id}/changePassword*

A `POST` request is used to to change a user password.
A user may only change their own password.
When the password is updated, an email will be sent to the user notifying them of the change.

==== Request structure

include::{snippets}/user-password-update-example/request-fields.adoc[]

==== Example request

include::{snippets}/user-password-update-example/curl-request.adoc[]

==== Example response

include::{snippets}/user-password-update-example/http-response.adoc[]

=== Remove User

*/user-registration/{id}/remove*

A `POST` request is used to remove a user.
This operation may only be performed by an admin.

Users records will remain in the database but are marked as inactive.

User Login Accounts are deleted from the identity management server.


==== Example request

include::{snippets}/user-remove-example/curl-request.adoc[]

==== Example response

include::{snippets}/user-remove-example/http-response.adoc[]


=== Restore User

*/user-registration/{id}/restore*

A `POST` request is used to restore a previously removed user.
This operation may only be performed by an admin.

Users records must already exist in the database and marked as inactive.
They will be restored to active following the successful completion of this command.

User Login Accounts are created in the identity management server.


==== Example request

include::{snippets}/user-restore-example/curl-request.adoc[]

==== Example response

include::{snippets}/user-restore-example/http-response.adoc[]
...
A logo link is also included in the response if the dealer or oem associated with the user has a custom logo.
If a user is associated with a dealer and an oem each with custom logos, the dealer logo is used.
...
This command sets time on spa, if spa is JACUZZI then also date can be set (in such case date field is obligatory).

==== Request structure

include::{snippets}/control-settime-example/request-fields.adoc[]

If the originatorId is not sent in the request, one will be created

==== Example request

include::{snippets}/control-settime-example/curl-request.adoc[]

==== Example response

include::{snippets}/control-settime-example/http-response.adoc[]
...
[[resources-material-findbyOemIdAndMaterialType]]
=== List Materials of a single Material Type available to an OEM

*/materials/search/findByOemIdAndMaterialType*
...
include::{snippets}/materials-findbyOemIdAndMaterialType-example/response-fields.adoc[]

==== Example request

include::{snippets}/materials-findbyOemIdAndMaterialType-example/curl-request.adoc[]

==== Example response

include::{snippets}/materials-findbyOemIdAndMaterialType-example/http-response.adoc[]
