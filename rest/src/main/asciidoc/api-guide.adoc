...
=== Get Dealership Dashboard Info

A `GET` request will retrieve the dashboard statistics for a spa dealership
...
[[resources-dashboard-oem]]
=== Get Oem Dashboard Info

A `GET` request will retrieve the dashboard statistics for a spa Manufacturer
...
[[resources-dashboard-associate]]
=== Get Dealer Associate Dashboard Info

A `GET` request will retrieve the dashboard statistics for a spa sales associate

==== Response structure

include::{snippets}/dashboard-associate-example/response-fields.adoc[]

==== Example request

include::{snippets}/dashboard-associate-example/curl-request.adoc[]

==== Example response

include::{snippets}/dashboard-associate-example/http-response.adoc[]


[[resources-dashboard-technician]]
=== Get Technician Dashboard Info

A `GET` request will retrieve the dashboard statistics for a spa technician

==== Response structure

include::{snippets}/dashboard-technician-example/response-fields.adoc[]

==== Example request

include::{snippets}/dashboard-technician-example/curl-request.adoc[]

==== Example response

include::{snippets}/dashboard-technician-example/http-response.adoc[]


[[resources-dashboard-bwg]]
=== Get Balboa Dashboard Info

A `GET` request will retrieve the dashboard statistics for the entire system

==== Response structure

include::{snippets}/dashboard-bwg-example/response-fields.adoc[]

==== Example request

include::{snippets}/dashboard-bwg-example/curl-request.adoc[]

==== Example response

include::{snippets}/dashboard-bwg-example/http-response.adoc[]
